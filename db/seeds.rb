...
10.times do
  ...
  rocket = Rocket.new(capacity: Rocket::ROCKETS[ Rocket::ROCKETS.keys.sample][:capacity], model: Rocket::ROCKETS[ Rocket::ROCKETS.keys.sample][:model], name: Faker::Space.nasa_space_craft, photo: '../assets/images/xwing.png' )
  rocket.user = user
  rocket.save!
  5.times do
