...
10.times do
  ...
  rocket = Rocket.new(capacity: Rocket::ROCKETS[ Rocket::ROCKETS.keys.sample][:capacity], model: Rocket::ROCKETS[ Rocket::ROCKETS.keys.sample][:model], name: Faker::Space.nasa_space_craft, photo: 'images/' )
  rocket.user = user
  rocket.save!
